...
object EnvVars {
    ...
    val worldServerToken: String = dotenv.get("WORLD_SERVER_TOKEN", "ev9+VAp5/tMKeNR/7MOuH6lKWS+rGkHK")
    ...
    val js5Keys: String = dotenv.get("JS5_KEYS", "1441,78700,44880,39771,363186,44375,0,16140,7316,271148,810710,216189,379672,454149,933950,21006,25367,17247,1244,1,14856,1494,119,882901,1818764,3963,3618")
