...
interface CacheLoader {
    ...
    fun load(xteas: Map<Int, IntArray>? = null): Cache {
        return load(EnvVars.cachePath, BigInteger(EnvVars.js5RsaExponent), BigInteger(EnvVars.js5RsaModulus), threadUsage = EnvVars.cacheThreadUsage)
    }
